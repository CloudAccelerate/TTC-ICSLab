...
**1.2.10** Select *No Authentication* from the picklist of _Security Policies_ (because only ICS credentials will be needed for this SOAP API), then select the *OK* button.
